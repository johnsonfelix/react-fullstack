...
Based on the provided Scope of Work (SOW) summary, generate a list of 3-5 key deliverables.
Return the result as a simple JSON object with a single key "deliverables" containing an array of strings.
...
`;
        ...
        console.error("AI Deliverables Error:", error);
